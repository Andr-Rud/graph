...
@click.argument("speed_column", type=str, default="speed")
def main(input_stream_name_time: str, input_stream_name_length: str, output_file: str,
         ...
         speed_column: str = "speed") -> None:
    result = yandex_maps_graph(input_stream_name_time, input_stream_name_length,
